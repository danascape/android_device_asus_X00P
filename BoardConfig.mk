...
# Kernel
BOARD_KERNEL_CMDLINE := console=ttyHSL0,115200n8 androidboot.console=ttyHSL0
...
BOARD_SUPER_PARTITION_VENDOR_DEVICE_SIZE   := 681574400
BOARD_SUPER_PARTITION_SYSTEM_DEVICE_SIZE   := 3460300800

BOARD_SUPER_PARTITION_SIZE := $(shell expr $(BOARD_SUPER_PARTITION_SYSTEM_DEVICE_SIZE) + $(BOARD_SUPER_PARTITION_VENDOR_DEVICE_SIZE) )

BOARD_SUPER_PARTITION_GROUPS := x00p_dynpart
BOARD_X00P_DYNPART_SIZE := $(shell expr $(BOARD_SUPER_PARTITION_SIZE) - 4194304 )
BOARD_X00P_DYNPART_PARTITION_LIST := $(ALL_PARTITIONS)
