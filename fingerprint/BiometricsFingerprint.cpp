 ...
 */
#define LOG_TAG "android.hardware.biometrics.fingerprint@2.1-service.X00P"
#define LOG_VERBOSE "android.hardware.biometrics.fingerprint@2.1-service.X00P"
...
static const hw_module_info_t kHALModules[] = {
	{"fpsensor_" FINGERPRINT_HARDWARE_MODULE_ID},
	{"mafp_factory", "default"},
